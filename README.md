...
This package exists because [langchain-community](https://github.com/langchain-ai/langchain-community) has been [deprecated and is no longer maintained](https://github.com/langchain-ai/langchain-community/issues/674), and uses deprecated functions from [arxiv.py](https://github.com/lukasschwab/arxiv.py). Lastly, the community implementation has accumulated footguns:
